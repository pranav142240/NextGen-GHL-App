...
class WebhookController extends Controller
{
    ...
    public function handle(Request $request)
    {
        ...
        // Log the cURL equivalent for manual testing
        // Log::info('cURL equivalent data for manual testing', [
        //     'endpoint' => 'PUT /contacts/{contactId} or POST /contacts/',
        //     'headers' => [
        //         'Authorization' => 'Bearer ' . $locationAccessToken,
        //         'Content-Type' => 'application/json'
        //     ],
        //     'body' => json_encode($contactData, JSON_PRETTY_PRINT),
        //     'curl_command' => 'curl -X POST "https://services.leadconnectorhq.com/locations/' . $locationId . '/contacts" -H "Authorization: Bearer ' . $locationAccessToken . '" -H "Content-Type: application/json" -d \'' . json_encode($contactData) . '\''
        // ]);

        // COMMENTED OUT FOR VERIFICATION - Uncomment when ready to test
        try {
